...
val remove_from_person : person_id:int -> tag_id:int -> (unit, Caqti_error.t) result
...
val add_to_article : article_id:int -> tag_id:int -> (unit, Caqti_error.t) result
val remove_from_article : article_id:int -> tag_id:int -> (unit, Caqti_error.t) result
