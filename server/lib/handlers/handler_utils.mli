...
val parse_json_body : (Yojson.Safe.t -> 'a) -> Tapak.Request.t -> ('a, string) result
...
val or_uri_error : ('a, Service.Uri.Error.t) result -> ('a, Tapak.Response.t) result
val or_feed_error : ('a, Service.Rss_feed.Error.t) result -> ('a, Tapak.Response.t) result
val or_connection_error : ('a, Service.Connection.Error.t) result -> ('a, Tapak.Response.t) result
val or_tag_error : ('a, Service.Tag.Error.t) result -> ('a, Tapak.Response.t) result
val or_connection_metadata_error : ('a, Service.Connection_metadata.Error.t) result -> ('a, Tapak.Response.t) result
val or_uri_content_error : ('a, Service.Uri_content.Error.t) result -> ('a, Tapak.Response.t) result
